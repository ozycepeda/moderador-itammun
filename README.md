...
Prototipo funcional para preparar y conducir debates de ITAMMUN. El catálogo de comités, países, jueces, banderas, tópicos y cupos ocupados se consulta desde la API pública de `itammun.itam.mx`; el tópico, asistencia, oradores, tiempos y votos se guardan únicamente en el navegador.
...
- Finalizar la sesión descarga el mismo CSV del pase de lista, pide confirmación, elimina el debate local y regresa al selector de comités.
