...
test("exports every participant with session metadata, attendance, warnings, and faults", () => {
  const participants = [
    { id: "mx", name: "México", observer: false, status: "occupied" },
    { id: "holy-see", name: "Santa Sede, Observador", observer: true, status: "available" },
  ];
  ...
  assert.match(csv, /México,Presente y votando,Sí,No,9,1,2/);
